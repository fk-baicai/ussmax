(function () {
    ...
    function pickInitialBlueprint() {
        ...
        if (id && !state.items.some(function (x) { return x.uuid === id; })) {
            ...
            id = state.items[0].uuid;
        }
        if (!id) id = state.items[0].uuid;
    ...
    function renderMissions() {
        ...
        window.ShipComponentBlueprints.mount(el.missions, blueprintMissionItem(bp)).then(function () {
